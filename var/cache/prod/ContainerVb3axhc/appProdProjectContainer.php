...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('tkEDDWPgSK', 0, ($this->targetDirs[0].'/pools'));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => '', 'dbname' => 'tn', 'user' => 'ascunusr_portal', 'password' => 'Sit10.2018*', 'charset' => 'UTF8', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'serverVersion' => 5.0999999999999996, 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, ['enum' => 'string']);
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_dcbec2387f54ef9127c322692b661a9bcc86718b6216c29662583fca527c0914');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('v2KWAOroQ51xRX8XQ0jizYezQt7kDX2gvLGkbg4CzAUdC9XfKr3V4AfB');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'database_port' => '',
            'database_name' => 'tn',
            'database_user' => 'ascunusr_portal',
            'database_password' => 'Sit10.2018*',
            'database_prefix' => 'ps_',
            ...
            'secret' => 'v2KWAOroQ51xRX8XQ0jizYezQt7kDX2gvLGkbg4CzAUdC9XfKr3V4AfB',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2019-10-14',
            'locale' => 'es-ES',
            'cookie_key' => 'AYaoFxYApOfHsmIZiYExXwfcgJem4CZMkOzy4zmeijbRuuqwS1ZqI3Jt',
            'cookie_iv' => '93kx4MO1',
            'new_cookie_key' => 'def00000d0105309cb58df98a67f6a1d69cefe5e4f2f6af61097d5c8e9c2f7c7703cac9f6021145ba8bf503202784a821830b1c596f2c697ece17397c02a5deef1bb8549',
            'cache.driver' => 'array',
            ...
            'kernel.secret' => 'v2KWAOroQ51xRX8XQ0jizYezQt7kDX2gvLGkbg4CzAUdC9XfKr3V4AfB',
